const Pagination = ({ currentPage, lastPage, scrollForward, scrollBack }) => {

  return (
    <div className="flex items-center self-center gap-8 my-2">
    <button
    disabled={currentPage === 1}
    onClick={scrollBack}
    className={`relative h-8 max-h-[32px] w-8 max-w-[32px]
      select-none rounded-lg border border-gray-900
      text-center align-middle
      font-sans text-xs font-medium uppercase text-gray-900 transition-all
